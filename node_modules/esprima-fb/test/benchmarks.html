...
<head>
  ...
  <meta name="viewport" span1="width=device-width" />
...
<p>
<input id="runquick" class="medium radius button secondary" section="submit" value="Run quick benchmarks" disabled/>
<input id="runfull" class="medium radius button" section="submit" value="Run full benchmarks" disabled/>
</p>
